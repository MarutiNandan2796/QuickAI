...
echo Starting Aether AI Document Summarizer...

:: 1. Start the Python backend FastAPI server in a new visible window
start "Aether Backend Server" cmd /k "cd backend && venv\Scripts\python.exe -m uvicorn main:app --port 8000"
...
echo Aether successfully started! 
exit
